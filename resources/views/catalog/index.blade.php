            ...
            <div class="flex flex-col lg:flex-row gap-12 lg:gap-6 2xl:gap-8 mt-8">
                ...
                <div class="basis-auto xl:basis-3/4">
                        ...
                        <div class="flex items-center gap-4">
                            <div class="flex items-center gap-2">
                                <a href="{{ filter_url($category, ['view' => 'grid']) }}" 
                                    ...
                                    @endif 
                                      inline-flex items-center justify-center w-10 h-10 rounded-md bg-card
                                    ">
                                ...
                                <a href="{{ filter_url($category, ['view' => 'list']) }}" 
                                    ...
                                    @if(is_catalog_view('list'))
                                     text-pink pointer-events-none 
                                    @else text-white hover:text-pink 
                                    @endif inline-flex items-center justify-center w-10 h-10 rounded-md bg-card
                                    ">
                                    <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 52 52">
                    ...
                    <div class="
                        ...
                        grid-cols-1 gap-y-8
                        @else
                        grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-x-6 2xl:gap-x-8 gap-y-8 lg:gap-y-10 2xl:gap-y-12
                        @endif
                        ">
